...
def generate_launch_description():
    os.environ['ROBOT_TYPE'] = 'x3'
    os.environ['RPLIDAR_TYPE'] = 'a1'
   ...
   #     executable='static_transform_publisher',
        ...
        # x: -0.075 (逻辑车头在原车尾，所以雷达在后方 7.5cm)
        # y: 0.0 (中心线上)
        # z: 0.11 (高度保持不变)
        # yaw: 0.0 (雷达 X 轴已指向新车头方向)
   #     arguments = ['-0.075', '0.0', '0.11', '3.14159', '0.0', '0.0', 'base_link', 'laser']
  #  )
